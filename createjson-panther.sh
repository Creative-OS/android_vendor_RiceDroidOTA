...
device="panther" #ex: guacamole
devicename="Pixel 7" #ex: OnePlus 7 Pro
zip="riceDroid-13.0-202302061940-panther-v10.1-AOSP-COMMUNITY-img.zip" #ex: crDroidAndroid-<android version>-<date>-<device codename>-v<ricedroid version>.zip
