...
device="oriole" #ex: guacamole
devicename="Pixel 6" #ex: OnePlus 7 Pro
zip="riceDroid-13.0-$(date +%Y%m%d%H%M)-$device-v10.1-PIXEL-OFFICIAL-img.zip" #ex: crDroidAndroid-<android version>-<date>-<device codename>-v<ricedroid version>.zip
