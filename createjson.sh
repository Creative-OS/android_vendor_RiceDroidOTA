...
zip="riceDroid-13.0-2023010216-raven-v10.0-PIXEL-OFFICIAL-OPEN-BETA-img.zip" #ex: crDroidAndroid-<android version>-<date>-<device codename>-v<ricedroid version>.zip
